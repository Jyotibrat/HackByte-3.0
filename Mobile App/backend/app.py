...
MODEL_CONFIGS = {
    "multi_modal": {
        "name": "multi_modal",
        "urls": [
            "https://b267-34-143-225-145.ngrok-free.app/",
            "https://second-ngrok-url.ngrok-free.app/",
    ...
    "stable_diffusion": {
        ...
        "urls": ["https://4c3f-34-142-242-167.ngrok-free.app/"]
    },
    "floor_gpt": {
        "name": "floor_gpt",
        "urls": ["https://4c3f-34-142-242-167.ngrok-free.app/"]
...
def generate_images(prompt, model_choice):
    ...
    for i, url in enumerate(urls):
        try:
            ...
            # Disable SSL verification for ngrok URLs
            response = requests.post(f"{url}/generate", json=data, timeout=30, verify=False)
...
def generate_floor_plan():
    ...
    try:
        ...
        return jsonify({
            'success': True,
            'images': images  # Return all generated images
        })
